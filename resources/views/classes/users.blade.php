                ...
                <td class="p-4 flex justify-center space-x-2">
                    <form action="{{ 'test' }}" method="POST">
                        ...
                        <div class="relative w-6 h-6">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="absolute left-0 bottom-0 text-yellow-600 h-full w-full pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">

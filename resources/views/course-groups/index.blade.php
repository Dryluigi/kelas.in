...
<table class="border border-gray-600 text-center w-full pt-4">
    <thead class="border-b border-gray-600 p-4 bg-indigo-300">
        ...
        <th class="p-4">Jumlah Mata Pelajaran</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="p-4">{{ $group->courses_count }}</td>
            ...
            <td class="p-4">{{ $group->created_at }}</td>
            <td class="p-4 flex justify-center space-x-2">
                <a href="{{ route('classes.course-groups.show', [$class, $group])}}">
                ...
                <a href="{{ route('classes.course-groups.edit', [$class, $group]) }}">
                ...
                <form action="{{ route('classes.course-groups.delete', [$class, $group]) }}" method="POST">
                    @csrf
                    @method('DELETE')
